...
namespace DataFac.Memory
{
    ...
    public struct BlockB032 : IMemBlock, IEquatable<BlockB032>
    {
        ...
        public bool Equals(BlockB032 other) => BlockHelper.AsReadOnlySpanOfInt64(ref this).SequenceEqual(BlockHelper.AsReadOnlySpanOfInt64(ref other));
        ...
        public static bool operator ==(BlockB032 left, BlockB032 right) => left.Equals(right);
        public static bool operator !=(BlockB032 left, BlockB032 right) => !left.Equals(right);
    }
