...
namespace DataFac.Memory
{
    ...
    public struct BlockB256 : IMemBlock, IEquatable<BlockB256>
    {
        ...
        public bool Equals(BlockB256 other) => BlockHelper.AsReadOnlySpanOfInt64(ref this).SequenceEqual(BlockHelper.AsReadOnlySpanOfInt64(ref other));
        public override bool Equals(object? obj) => obj is BlockB256 other && Equals(other);
        ...
        public static bool operator ==(BlockB256 left, BlockB256 right) => left.Equals(right);
        public static bool operator !=(BlockB256 left, BlockB256 right) => !left.Equals(right);
    }
