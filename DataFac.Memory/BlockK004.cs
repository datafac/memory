...
namespace DataFac.Memory
{
    ...
    public struct BlockK004 : IMemBlock, IEquatable<BlockK004>
    {
        ...
        public bool Equals(BlockK004 other) => BlockHelper.AsReadOnlySpanOfInt64(ref this).SequenceEqual(BlockHelper.AsReadOnlySpanOfInt64(ref other));
        ...
        public static bool operator ==(BlockK004 left, BlockK004 right) => left.Equals(right);
        public static bool operator !=(BlockK004 left, BlockK004 right) => !left.Equals(right);
    }
